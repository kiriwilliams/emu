...
const Blockquote = () => (
    <div className="container my-4 adjust-padding">
        ...
        <blockquote className="blockquote text-center align-items-center">
            <p className="mb-0 quote">&ldquo;<strong> Writing in a journal each day</strong> allows you to direct your focus to what you accomplished, what you're grateful for and what you're committed to doing better tomorrow. This, you are more deeply enjoy your journey each day. &rdquo;</p>
